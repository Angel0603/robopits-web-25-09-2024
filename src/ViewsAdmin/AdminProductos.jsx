  ...
  return (
    <div>
      ...
      <div className="w-full h-auto p-8">
        ...
        <div className="mx-auto my-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {/* Show existing products */}
          {productos.map(producto => (
            <div key={producto.IdProducto} className="w-full bg-slate-100 rounded-md p-4 my-5">
              <div className="flex flex-col items-center ">
                ...
                <div className="flex justify-center space-x-4">
                  <button onClick={() => openProductDetails(producto)} className="bg-[#329696] text-white px-3 py-1 rounded-md">Ver Producto</button>
                </div>
              </div>
            </div>
          ))}
